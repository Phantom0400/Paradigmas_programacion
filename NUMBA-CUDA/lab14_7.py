#***************************************************************
""" Método de montecarlo con comunicacion entre procesos """
...
if __name__ == "__main__":
    ...
    for proceso in procesos:
        proceso.join()
    print('Numero de tiros: ' + str(cpus*N))
    print('Número de aciertos: ' + str(resultado.value))
    print('Aproximacion de PI: ' + str(4*float(resultado.value)/(cpus*N)))
#***************************************************************
